...
export default function ProjectsPage() {
  ...
  const projects = [
    ...
    {
      title: "UAE Cleaning Directory",
      description: "Directory website listing cleaning services across UAE with search functionality.",
      image: "/placeholder.svg?height=300&width=500",
    ...
    },
    {
      ...
      description: "Website for an IT training institute in Delhi with course management system.",
      image: "/placeholder.svg?height=300&width=500",
    ...
    {
      title: "Cleaning Blog",
      description: "Hindi cleaning blog with articles and tips about cleaning services and products.",
      image: "/placeholder.svg?height=300&width=500",
    ...
    {
      title: "Vacuum Cleaners Review",
      description: "Blog reviewing vacuum cleaners with comparison features and buying guides.",
      image: "/placeholder.svg?height=300&width=500",
      tags: ["Digital Marketing", "Blog"],
      category: "Digital Marketing",
      demoUrl: "#",
    ...
    },
    {
      ...
      description: "Mobile app for an e-commerce store with product catalog and checkout functionality.",
      image: "/placeholder.svg?height=300&width=500",
